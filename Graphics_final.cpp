...
void render_tree2() {
    ...
    // Apply translation and scaling to the building object
    glPushMatrix();
    glTranslatef(145.0f, 34.0f, 0.0f); // Translate to the building's original position in the old project
...
// Function to set up the orthographic projection for the axes
void identity_axis() {
    glMatrixMode(GL_PROJECTION);
...
void windmill_stand()  //id26
{
    glColor3ub(165, 42, 42);
    glBegin(GL_QUADS);
    glVertex2f(15.5f, 81.0f);
    glVertex2f(16.5f, 81.0f);
...
void render_car() {
    ...
    // Apply translation and scaling to the building object
    glPushMatrix();
    glTranslatef(10.0f + move_left_car, 28.0f, 0.0f); // Translate to the building's original position in the old project
    glScalef(0.12f, 0.40f, 0.0f); // Scale down to fit the new project's coordinate system
    displayCar();
    glPopMatrix();
...
void render_truck() {
    ...
    // Apply translation and scaling to the building object
    glPushMatrix();
    glTranslatef(36.0f - move_right_car, -135.0f, 0.0f); // Translate to the building's original position in the old project
    glScalef(0.23f, 0.95f, 0.0f); // Scale down to fit the new project's coordinate system
    display_Truck();
    glPopMatrix();
...
void render_windmill() {
    ...
    // Apply translation and scaling to the building object
    glPushMatrix();
    glTranslatef(125.0f, 48.0f, 0.0f); // Translate to the building's original position in the old project
    glScalef(0.12f, 0.60f, 0.0f); // Scale down to fit the new project's coordinate system
    display_windmill();
    glPopMatrix();
